...
class BookingServiceTests {
    ...
    void createBookingTest() {
        ...
        Optional<Booking> booking = Optional.of(bookingService.add(2L, bookingDto));
    ...
    void createBookingUserNotFoundEndTest() {
        ...
        assertThrows(UserNotFoundException.class, () -> bookingService.add(2L, bookingDto));
    }
    ...
    void updateStatusTest() {
        Optional<BookingDtoResponse> bookingDtoResponse = Optional.of(bookingService.approve(1L, 1L, true));
    ...
    void getUnknownBookingTest() {
        assertThrows(BookingNotFoundException.class, () -> bookingService.get(1L, 10L));
    }
    ...
    void getByOwnerIdTest() {
        Optional<Booking> bookingDtoResponse = Optional.of(bookingService.get(1, 1));
